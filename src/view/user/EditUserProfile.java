...
public class EditUserProfile {
    public EditUserProfile(){
        ...
        oldPasswordLabel.setBounds(10, 50, 100, 25);

        JPasswordField oldPassword = new JPasswordField("");
        oldPassword.setBounds(150, 50, 165, 25);

        JLabel newPasswordLabel = new JLabel("New Password : ");
        newPasswordLabel.setBounds(10, 80, 100, 25);

        JPasswordField newPassword = new JPasswordField("");
        newPassword.setBounds(150, 80, 165, 25);
        ...
        saveButton.addActionListener(e -> {
            ...
            if (user == -1) {
                ...
                JOptionPane.showMessageDialog(null, "Update " + username + " successful!");
                frame.dispose();
            }
        });
